...
## About
The USDA's Economic Research Service (ERS) maintains consolidated, annual datasets for crop statistics like yield, planted area, harvested area, price, etc. for many staple crops like corn, cotton, soy, and wheat. For example:
 ...
 - Soy: [Oil Crops Yearbook](https://www.ers.usda.gov/data-products/oil-crops-yearbook)
  - Wheat: [Wheat Data](https://www.ers.usda.gov/data-products/wheat-data)
...
By default, both `Python` scripts in this repository will download or process data for every supported crop. For example, this command will download data from the WASDE site for `corn`, `cotton`, `soybeans`, and `wheat`:
```
