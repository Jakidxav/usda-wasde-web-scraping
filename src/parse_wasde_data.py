...
def pad_df_dates(df: pandas.DataFrame) -> pandas.DataFrame:
    """
...
def add_manual_data(crop: str) -> pandas.DataFrame:
    """
...
def parse_txt_files(filenames: list, crop: str) -> pandas.DataFrame:
    """
...
def parse_xls_files(filenames: list, crop: str) -> pandas.DataFrame:
    """
